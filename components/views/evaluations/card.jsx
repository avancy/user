...
export default function EvaluationCard({ id, name, description, status }) {
  const statusColor =
    EVALUATION_STATUS_COLORS[status] || EVALUATION_STATUS_COLORS.pending;
  ...
  return (
    <div className="flex flex-col min-w-[250px] md:w-[315px] h-[200px] md:h-[191px] rounded-xl shadow-md font-montserrat">
      ...
      <div className="flex flex-col flex-1 px-4 py-2">
        ...
        <p
          className="overflow-hidden text-sm text-ellipsis line-clamp-3"
          title={description}
        >
          {description}
        </p>
